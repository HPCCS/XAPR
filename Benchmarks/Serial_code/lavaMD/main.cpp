		...
		char *argv [])
{
	...
	#ifdef WRITE
	{
		...
		rv_cpu[i].v = rv_cpu[i].v / 10;			// get a number in the range 0.1 - 1.0
		fprintf(file,"%f\n",rv_cpu[i].v);
		rv_cpu[i].x = (rand()%10 + 1);			// get a number in the range 0.1 - 1.0
		rv_cpu[i].x = rv_cpu[i].x / 10;			// get a number in the range 0.1 - 1.0
		fprintf(file,"%f\n",rv_cpu[i].x);
		rv_cpu[i].y = (rand()%10 + 1);			// get a number in the range 0.1 - 1.0
		rv_cpu[i].y = rv_cpu[i].y / 10;			// get a number in the range 0.1 - 1.0
		fprintf(file,"%f\n",rv_cpu[i].y);
		rv_cpu[i].z = (rand()%10 + 1);			// get a number in the range 0.1 - 1.0
		rv_cpu[i].z = rv_cpu[i].z / 10;			// get a number in the range 0.1 - 1.0
		fprintf(file,"%f\n",rv_cpu[i].z);
	}
	#endif
	#ifdef READ
	...
	#ifdef WRITE
	{
		qv_cpu[i] = (rand()%10 + 1);			// get a number in the range 0.1 - 1.0
		qv_cpu[i] = qv_cpu[i] / 10;			// get a number in the range 0.1 - 1.0
		fprintf(file,"%f\n",qv_cpu[i]);
	}
	#endif
	#ifdef READ
	...
	//printf("the value of par_cpu.alpha is: %lf \n", par_cpu);
	//printf("the value of dim_cpu.cur_arg is: %d \n", dim_cpu.cur_arg);
	//printf("the value of dim_cpu.arch_arg is: %d \n", dim_cpu.arch_arg);
	//printf("the value of dim_cpu.cores_arg is: %d \n", dim_cpu.cores_arg);
	//printf("the value of dim_cpu.boxes1d_arg is: %d \n", dim_cpu.boxes1d_arg);
	//printf("the value of dim_cpu.number_boxes is: %ld \n", dim_cpu.number_boxes);
	//printf("the value of dim_cpu.box_mem is: %ld \n", dim_cpu.box_mem);
	//printf("the value of dim_cpu.space_elem is: %ld \n", dim_cpu.space_elem);
	//printf("the value of dim_cpu.space_mem is: %ld \n", dim_cpu.space_mem);
	//printf("the value of dim_cpu.space_mem2 is: %ld \n", dim_cpu.space_mem2);
	//int elem = sizeof(box_str);
	//int elems = sizeof(box_cpu);
	//printf("the size of box_str: %d \n", elem);
	//printf("the size of box_cpu: %d \n", elems);
