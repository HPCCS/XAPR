...
class BaseMultilayerPerceptron(six.with_metaclass(ABCMeta, BaseEstimator)):
    ...
    def _initialize(self, y, layer_units):
        ...
        # added for warm_start for transfer learning
        if self.warm_start==1:
            self.coefs_ = np.load('/Users/AnzhengGuolu/Documents/ml_model_new/inherit_weights.npy')
            self.intercepts_ = np.load('/Users/AnzhengGuolu/Documents/ml_model_new/inherit_intercepts.npy')
